...
{{--                </div>--}}
    <div class="row">
                ...
                <span class="input-group-text">عدد التجار</span>
                    <div>
                        ...
                        <div id="gr" style="display: none">
                            ...
                            <input type="text"   class="form-control" aria-label="Sizing example input" name="MerchantName2">
                            <span class="input-group-text" >الهاتف/المحمول</span>
                            <input type="text" class="form-control"  aria-label="Sizing example input" name="Merchantsphone2">
                            <span class="input-group-text">رقم الهوية</span>
                            <input type="number" class="form-control" aria-label="Sizing example input" name="IdentificationNumber2">
                            <span class="input-group-text" >رقم الفاتورة /البيان</span>
                            <input type="number" class="form-control"  aria-label="Sizing example input" name="invoiceNumber2">
                    </div>
                        <div>
                        ...
                        <label>متعدد التجار</label>
                            <table id="g" class="table table-bordered border-primar" style="display: none">
                                ...
                                <tbody>
                                <tr>
                                    <td id="col0"><input type="text" class="form-control" name="MerchantName[]" placeholder="Enter your name" ></td>
                                    <td id="col1"><input type="text" class="form-control" name="Merchantsphone[]" placeholder="Enter your phone" ></td>
                                    <td id="col2">
                                        <input type="number" class="form-control" name="IdentificationNumber[]" placeholder="Enter your phone">
                                    </td>
                                    <td id="col3">
                                        <input type="number" class="form-control" name="invoiceNumber[]" placeholder="Enter your phone">
                                    </td>
                                </tr>
                                </tbody>
                            </table>
        ...
        <div class="input-group mb-3">
            ...
            <input type="date" class="form-control" value="1" aria-label="Sizing example input" name="Date">
        </div>
                @error('Date')
                ...
                @enderror
                 <div>
                <input class="form-check-input" type="checkbox" value="زيوت معدنية" name="checkboxs[]">
                    <label> زيوت معدنية </label>
                </div>
                <div>
                    <input class="form-check-input" type="checkbox" value="قطع مستعملة" name="checkboxs[]">
                    <label> قطع مستعملة </label>
                </div>
                <div>
                    <input class="form-check-input" type="checkbox" value=" قطع جديدة" name="checkboxs[]">
    ...
    <div class="input-group input-group-lg">
        ...
        <br><br>
            ...
            <form>
                ...
                <div>
                    <div>
                        <input type="radio" id="test" name="Paymentstatus" value="مدفوع" />
                        <label>مدفوع</label>
                        <table id="first" class="table table-bordered border-primar" style="display: none">
                            ...
                            <tbody>
                            <tr>
                            <td id="c0"><input type="number" class="form-control" aria-label="Sizing example input" name="Receiptnumber[]"></td>
                            </tr>
                            </tbody>
                        </table>
                    ...
                    <table id="too" class="table table-bordered border-primar" >
                        ...
                        <tbody>
                        <tr>
                            <td id="co0"><input type="text" class="form-control" name="carNumber[]" placeholder="Enter your ID car" >
                                @error('carNumber[]')
                                <div class="alert alert-danger d-flex align-items-center" role="alert">
                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                                    <div>
                            ...
                            <td id="co1"><input type="text" class="form-control" name="ThedriverName[]" placeholder="Enter your name" >
                                @error('ThedriverName[]')
                                <div class="alert alert-danger d-flex align-items-center" role="alert">
                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                                    <div>
                            ...
                            <td id="co2">
                                <input type="number" class="form-control" name="DriverID[]" placeholder="Enter your ID">
                                @error('DriverID[]')
                                <div class="alert alert-danger d-flex align-items-center" role="alert">
                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                                    <div>
                            ...
                            <td id="co3">
                                <input type="tel" class="form-control" name="DriverMobileNumber[]" placeholder="Enter your phone">
                                @error('DriverMobileNumber[]')
                                <div class="alert alert-danger d-flex align-items-center" role="alert">
                                    <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                                    <div>
                                        {{ $message }}
